...
export function TransacoesUnificadas() {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    return transactions.filter(t => {
      ...
      return matchesSearch && matchesTipo && matchesEntity && matchesStatus;
    });
  }, [transactions, searchTerm, tipoFilter, entityFilter, statusFilter]);
  ...
  // Get entity ID for creating transactions (default to LOJA if filtered, otherwise first available)
                ...
                return (
                  <div 
                    ...
                    className={cn(
                      ...
                      isOverdue && t.status !== 'PAGO' && "bg-destructive/5"
                    )}
                  >
