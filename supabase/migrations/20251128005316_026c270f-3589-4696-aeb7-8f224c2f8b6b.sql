-- Corrigir função para criar receita com cast correto de status
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    -- Criar a transação de receita com cast correto
    INSERT INTO public.transactions (
      ...
      NEW.valor_total,
      CASE 
        WHEN NEW.status IN ('entregue', 'concluido', 'pago') THEN 'PAGO'::transaction_status
        ELSE 'PREVISTO'::transaction_status
      END,
      NEW.data_pedido,
      CASE 
